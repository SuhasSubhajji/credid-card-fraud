...
def MAIN():
  ...
  b1=Button(R1, text="Register",width=10,height=2,font=('algerain',14), bg="white", fg="red", command=m1)
  b1.place(x=200, y=200)
  
  b2=Button(R1, text="Login",width=10,height=2, font=('algerain',14), bg="white", fg="red", command=m3)
